...
public class CurrencyExchangeController {
	...
	public CurrencyExchangeController(CurrencyExchangeService currencyExchangeService, DiscountService discountService) {
		this.currencyExchangeService = currencyExchangeService;
		this.discountService = discountService;
	}

	/** 
	 * This methods is used to calculate discount and return amount in exchanged currency.
	 * @param requestBody
